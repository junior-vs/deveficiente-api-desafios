...
public class Autor {
    ...
    public String toString() {
        return String.format(
                "Autor [autorEmail=%s, autorID=%s, autorNome=%s, descricao=%s, tsAlteracao=%s]",
                autorEmail, autorID, autorNome, descricao, tsAlteracao);
    }

    public Autor(AutorForm autorForm) {
        this.autorID = autorForm.getAutorID();
        this.autorNome = autorForm.getAutorNome();
        this.autorEmail = autorForm.getAutorEmail();
        this.descricao = autorForm.getDescricao();
        this.tsAlteracao = autorForm.getTsAlteracao();
    }
