...
public class AutorController {
  ...
  @PostMapping
  @Transactional
  public ResponseEntity<AutorForm> createAutor(@Valid @RequestBody final AutorForm autor,
      UriComponentsBuilder builder) {

    AutorForm created = service.create(autor);
  ...
  @GetMapping("/{id}")
  public ResponseEntity<AutorForm> detalheAutor(@PathVariable Long id) {
